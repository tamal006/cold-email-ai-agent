...
export default function RegisterPage() {
  ...
  return /* @__PURE__ */ React.createElement(AuthLayout, null, /* @__PURE__ */ React.createElement("div", { className: "space-y-6" }, /* @__PURE__ */ React.createElement("div", { className: "lg:hidden flex items-center gap-3 mb-8" }, /* @__PURE__ */ React.createElement("div", { className: "h-10 w-10 rounded-xl bg-primary/10 flex items-center justify-center" }, /* @__PURE__ */ React.createElement(Mail, { className: "h-5 w-5 text-primary" })), /* @__PURE__ */ React.createElement("span", { className: "text-2xl font-bold gradient-text" }, "MailCraft AI")), /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement("h2", { className: "text-3xl font-bold" }, "Create an account"), /* @__PURE__ */ React.createElement("p", { className: "text-muted-foreground" }, "Start sending AI-powered cold emails today")), /* @__PURE__ */ React.createElement("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-4" }, /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ React.createElement(Label, { htmlFor: "register-name" }, "Full Name"), /* @__PURE__ */ React.createElement(
    Input,
    {
      id: "register-name",
      type: "text",
